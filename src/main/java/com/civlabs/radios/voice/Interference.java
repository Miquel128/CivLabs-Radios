...
public class Interference {
    ...
    public void mixStatic(short[] pcm, double noiseAmp) {
        ...
        for (int i = 0; i < pcm.length; i++) {
            ...
            // simple flutter (very slow amplitude wobble) to feel "RF-ish"
            // (tiny CPU cost; deterministic enough per frame)
            // you can remove this if you want perfectly steady noise
            // double wobble = 0.9 + 0.2 * Math.sin(i * 2 * Math.PI / 480.0);
            double wobble = 1.0;
